...
from ultralytics.data import build_dataloader, build_yolo_dataset, build_event_dataset, converter
from ultralytics.engine.validator import BaseValidator
from ultralytics.utils import LOGGER, ops
from ultralytics.utils.checks import check_requirements
from ultralytics.utils.metrics import ConfusionMatrix, DetMetrics, box_iou
from ultralytics.utils.plotting import output_to_target, plot_images, plot_events
...
class DetectionValidator(BaseValidator):
    ...
    def build_dataset(self, img_path, mode="val", batch=None):
        ...
        """
        if self.args.representation:
            return build_event_dataset(self.args, img_path, batch, self.data, mode=mode, stride=self.stride)
        else:
