...
from ultralytics.data.dataset import GroundingDataset, YOLODataset, EventDataset, YOLOMultiModalDataset
...
def build_yolo_dataset(cfg, img_path, batch, data, mode="train", rect=False, stride=32, multi_modal=False):
    ...
    return dataset(
        ...
        imgsz=cfg.imgsz,
        batch_size=batch,
        augment=(mode=="train") and cfg.augmentation,  # augmentation
...
def build_event_dataset(cfg, img_path, batch, data, mode="train", rect=False, stride=32):
    """Build Event Dataset."""
